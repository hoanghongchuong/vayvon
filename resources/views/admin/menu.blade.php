<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Quản lý loại giao dịch</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">            
            
            <li><a href="backend/news?type=tin-chap"><i class="fa fa-circle-o"></i> <span>Vay tín chấp</span></a></li>        
        ...
        <li><a href="backend/slogan"><i class="fa fa-gear" aria-hidden="true"></i> <span>Các bước nhân vay</span></a></li>
